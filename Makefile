...
# set up sources
ASM_SRC = $(SOURCE_DIR)/BLHeli_S.asm
ASM_INC = $(addsuffix .inc,$(addprefix $(SOURCE_DIR)/,$(TARGETS))) $(SOURCE_DIR)/BLHeliBootLoad.inc $(SOURCE_DIR)/BLHeliPgm.inc $(SOURCE_DIR)/SI_EFM8BB1_Defs.inc $(SOURCE_DIR)/SI_EFM8BB2_Defs.inc
